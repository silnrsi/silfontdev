...
to provide development versions of the current work ("zip" is the Windows-targeted artifact with Windows line-endings and "tar.xz" is the macOS/Linux-targeted artifact with Unix line-endings, the current git hash and a -dev suffix will be added to the name of the artifacts to help distinguish ongoing work vs. released font), type: 
